...
public class CategoryRepository extends CategoryLibrary implements
	...
	public void loadContents(String search) {
		...
		controller.action(ExecuteWorker.class, SearchRepo.class, this, search,
				gallery.getPreferredCellWidth(), gallery.getPreferredCellHeight(), null,
				category);
	}
	...
	public void nextPage() {
		this.canSearch = false;
		controller.action(ExecuteWorker.class, SearchRepo.class, this, search,
                gallery.getPreferredCellWidth(), gallery.getPreferredCellHeight(),
    ...
    public Cell addTile(Object id, String title, String thumbnailPath) {
        ...
        Pixmap repoThumbnail = new Pixmap(assets.resolve(thumbnailPath));
        Texture thumbnailTex = new Texture(repoThumbnail);

        return gallery.add(WidgetBuilder.repoTile((RepoElement) id, thumbnailTex,
                repoThumbnail));
    }
